        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameNormalized = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Brand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BrandNormalized = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_UserId_CreatedAt_Status",
                table: "Orders",
                columns: new[] { "UserId", "CreatedAt", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_BrandNormalized",
                table: "Products",
                column: "BrandNormalized");

            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_Price_IsActive",
                table: "Products",
                columns: new[] { "CategoryId", "Price", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductId_Size_Color_Stock",
                table: "ProductVariants",
                columns: new[] { "ProductId", "Size", "Color", "Stock" });
